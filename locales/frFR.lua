...
L["ROUTES_DISCLAIMER"] = "Par défaut, Keystone Percentage Helper utilise les routes hebdomadaires de Raider.IO (Débutant). Les routes personnalisées vous permettent de définir vos propres routes. Pour activer ces routes, assurez-vous d'activer \"Routes personnalisées\" dans les paramètres généraux de l'addon."
