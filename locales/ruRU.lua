...
L["ROLES_ENABLED"] = "Role(s) required" -- To Translate
L["ROLES_ENABLED_DESC"] = "Select which roles will see the percentage and inform the group" -- To Translate
L["LEADER"] = "Leader" -- To Translate
L["TANK"] = "Tank" -- To Translate
L["HEALER"] = "Healer" -- To Translate
L["DPS"] = "Damage" -- To Translate
