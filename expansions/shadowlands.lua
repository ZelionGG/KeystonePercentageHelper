...
KeystonePercentageHelper.SL_DUNGEONS = {
    ...
    [382] = {{1, 22.59, false, false}, {2, 76.81,  true, false},  {3, 100,   true,  false},  {4, 100,   true, false}, {5, 100,   true, false}}, -- [ToP] Theater of Pain
}
...
KeystonePercentageHelper.SL_DEFAULTS = {
    ...
    ToP = { BossOne = 22.59, BossOneInform = false, BossTwo = 76.81, BossTwoInform = true, BossThree = 100, BossThreeInform = true, BossFour = 100, BossFourInform = true, BossFive = 100, BossFiveInform = true }
}
